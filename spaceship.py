...
class Sprite:
    ...
    def collide(self, other_object):
        center_dist = dist(self.pos, other_object.pos)
        if center_dist <= self.get_radius() + other_object.get_radius():
            return True
        else:
            return False
...
def rock_spawner():
    ...
    if dist(my_ship.pos,a_rock.pos) > my_ship.radius + a_rock.radius + 30:
